/*
 * Copied from
 * https://github.com/worldcoin/world-id-starter-hardhat/blob/main/test/helpers/InteractsWithWorldID.ts
 */

import { Strategy,ZkIdentity } from "@zk-kit/identity";
import { generateMerkleProof, MerkleProof, Semaphore, SemaphoreSolidityProof,StrBigInt } from "@zk-kit/protocols";
